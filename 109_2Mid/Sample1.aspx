...
<body>
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="tb_Acc" runat="server" Height="15px" Width="200px"></asp:TextBox><br/>
            ...
            <asp:RadioButton ID="RadioButton1" runat="server" Font-Size="X-Large" Text="看書" AutoPostBack="True" Checked="True" OnCheckedChanged="RadioButton1_CheckedChanged" GroupName="rbg_Interest" />
            <asp:RadioButton ID="RadioButton2" runat="server" Font-Size="X-Large" Text="打電動" GroupName="rbg_Interest" />
            <asp:RadioButton ID="RadioButton3" runat="server" Font-Size="X-Large" Text="其他" GroupName="rbg_Interest" /><br/>
